...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $update_data = "UPDATE jopit SET name='$product_name', price='$product_price', image='$product_image'  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <?php
      ...
      $select = mysqli_query($conn, "SELECT * FROM jopit WHERE id = '$id'");
